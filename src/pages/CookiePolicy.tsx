    ...
    return (
        <main className={cn(s._, 'wrapper')}>
            ...
            <div className="text">
                ...
                <p>Обратите внимание, что вы можете отозвать свое согласие в любое время, изменив настройки вашего веб-браузера, как указано <a href="https://azurgames.com/ru/cookie-policy/#cookie">здесь</a>.</p>
                ...
                <p><strong>Что вы можете сделать, если вы не хотите хранить файлы cookie или хотите удалить их?</strong></p>
